...
class TestUserManagement(TestCase):
    def setUp(self):
        ...
        self.user = ShopUser.objects.create_user('stanley', \
                                                 'stanley@geekshop.local', 'geekbrains')

        self.user_with__first_name = ShopUser.objects.create_user('stanford', \
                                                                  'stanford@geekshop.local', 'geekbrains',
                                                                  first_name='Стэн')
    ...
    def test_user_login(self):
        ...
        # данные пользователя
        self.client.login(username='stanley', password='geekbrains')
    ...
    def test_user_register(self):
        ...
        new_user_data = {
            ...
            'email': 'johnnyboy@geekshop.local',
            'age': '21'}
    ...
    def test_user_wrong_register(self):
        new_user_data = {
            ...
            'password1': 'geekbrains',
            'password2': 'geekbrains',
            'email': 'unicorn1love@geekshop.local',
            'age': '13'}
